...
namespace Vovin.CmcLibNet.Export
{
    ...
    internal class ExcelWriter : BaseWriter
    {
        ...
        // because we use a new Xml writer for writing.
        // these methods do not subscribe to the datareader events
        ...
        private void SetDataTypeForCells(ExportProgressChangedArgs e)
        {
